# Лабораторная работа №4. Underlay. BGP (Super-Spine + 3 Spine + Leaf)
...
Каждый Spine должен передать 3 префикса (его Loopback, Loopback Leaf и, возможно, ещё один – так как каждый Spine знает о Leaf через прямой линк).
